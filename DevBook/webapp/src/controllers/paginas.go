...
func CarregarPaginaDeEdicaoDePublicacao(w http.ResponseWriter, r *http.Request) {
	...
	response, erro := requisicoes.FazerRequisicaoComAutenticacao(r, "GET", url, nil)
	if erro != nil {
		respostas.JSON(w, http.StatusInternalServerError, respostas.ErroAPI{Erro: erro.Error()})
		return
	}
...
// CarrgarPaginaDeAtualizacaoDeSenha carrega a página para atualização da senha do usuário
func CarrgarPaginaDeAtualizacaoDeSenha(w http.ResponseWriter, r *http.Request) {
